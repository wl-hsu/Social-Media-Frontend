...
const CreatTweet = () => {
  ...
  const onClickCreate = () => {
    createTweet({
      ...
      if (res.success) {
        Toast.show('Tweet successfully');
        go();
        return;
      }
      Toast.show('Tweet unsuccessfully');
    });
  };
  ...
  const onChangeUpFile = (v) => {
    ...
    Toast.show('Only 4 images can be uploaded');
  };
    ...
    <div className={style.container}>
      ...
      <div className={style.content}>
        ...
        <div className={style.right}>
          <TextArea rows={5} value={content} onChange={onChangeContent} className={style.text} placeholder="What's happening?" />
